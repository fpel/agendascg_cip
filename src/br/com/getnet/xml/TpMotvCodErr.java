...
/**
 * 
 *                 Tipo do motivo da operação realizada no sistema com atributo para retorno de código de erro.
 *             
 * 
 * <p>Java class for TpMotvCodErr complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TpMotvCodErr">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.cip-bancos.org.br/ARQ/ASCG026.xsd>TpMotv">
...
@XmlType(name = "TpMotvCodErr", propOrder = {
    "value"
})
public class TpMotvCodErr {
     ...
     *             Motivo da liquidação antecipada, representada por um tipo no dicionário de
     *             domínios
     *           &lt;/cat:DescricaoTipo&gt;
     *         &lt;/cat:InfTipo&gt;
     * </pre>
